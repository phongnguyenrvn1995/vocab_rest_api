...
public class RepositoryImpl implements IRepository{
	...
	@Override
	public int getAllVocabByTypeIDCount(String searchStr, int id) {
		return VocabDBFunc.getAllByTypeIDCount(searchStr, id);
	}
	...
	@Override
	public int getAllVocabByLessonIDCount(String searchStr, int id) {
		return VocabDBFunc.getAllByLessonIDCount(searchStr, id);
	}
